...
const SchemeItem = ({
  ...
  return (
    ...
    >
      {/* Item header with label and arrow icon */}
      <div className="item-header">
        <div className="item-label" onClick={() => setIsExpanded(!isExpanded)}>
        ...
        {isExpanded && (
          ...
          >
            {enabled ? (
              ...
              <p className="disabled-message">Dit item is uitgeschakeld.</p>
            )}
