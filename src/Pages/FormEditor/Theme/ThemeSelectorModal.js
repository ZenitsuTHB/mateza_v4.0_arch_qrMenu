...
const initialThemes = [
  ...
  { id: 2, title: 'Sandy Beach', color: '#F0E68C', image: image23 },
  { id: 3, title: 'Sunset Orange', color: '#FF7F50', image: image6 },
  { id: 4, title: 'Pastel Dreams', color: '#F8C8DC', image: image7 },
  { id: 5, title: 'Deep Blue', color: '#154360', image: image8 },
  { id: 6, title: 'Bordeaux Bliss', color: '#7D3C98', image: image20 },
  { id: 7, title: 'Forest Whisper', color: '#229954', image: image13 },
  { id: 8, title: 'Golden Hour', color: '#F4D03F', image: image14 },
  { id: 9, title: 'Coral Reef', color: '#FF6F61', image: image18 },
  { id: 10, title: 'Lavender Field', color: '#AF7AC5', image: image11 },
  { id: 11, title: 'Midnight Blue', color: '#34495E', image: image3 },
  { id: 12, title: 'Rosewood', color: '#B03A2E', image: image22 },
  { id: 13, title: 'Mint Fresh', color: '#48C9B0', image: image4 },
  { id: 14, title: 'Autumn Leaves', color: '#D35400', image: image10 },
  { id: 15, title: 'Creamy Beige', color: '#F5CBA7', image: image25 },
  { id: 16, title: 'Slate Gray', color: '#7F8C8D', image: image19 },
  { id: 17, title: 'Blush Pink', color: '#F1948A', image: image17 },
  { id: 18, title: 'Emerald Isle', color: '#1ABC9C', image: image9 },
  { id: 19, title: 'Chocolate Delight', color: '#6E2C00', image: image16 },
  { id: 20, title: 'Sunflower', color: '#F1C40F', image: image5 },
  { id: 21, title: 'Deep Purple', color: '#4A235A', image: image21 },
  { id: 22, title: 'Teal Twist', color: '#117A65', image: image12 },
  { id: 23, title: 'Burnt Orange', color: '#D35400', image: image2 },
  { id: 24, title: 'Soft Peach', color: '#FAD7A0', image: image24 },
  { id: 25, title: 'Royal Blue', color: '#2E86C1', image: image15 },
];
